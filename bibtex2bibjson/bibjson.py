...
def collection_from_dict(entries, **kwargs):
    ...
    entries = add_additional_items(entries)
...
def add_additional_items(entries):
    for entry in entries.keys():
        entries[entry]['slides'] = ''
        entries[entry]['video'] = ''
        entries[entry]['repo'] = ''
        entries[entry]['pdf'] = 'assets/pdfs/' + entry + '.pdf'
...
def fill_record_article(r, entry):
    ...
    _simple_fill(r, entry, ('title', 'year', 'note', 'key', 'slides', 'video', 'repo', 'pdf'))
...
def fill_record_book(r, entry):
    ...
    _simple_fill(r, entry, ('title', 'year', 'note', 'key', 'volume', 'number', 'series', 'edition', 'month', 'slides', 'video', 'repo', 'pdf'))
...
def fill_record_booklet(r, entry):
    ...
    _simple_fill(r, entry, ('title', 'howpublished', 'address', 'month', 'year', 'note', 'key', 'slides', 'video', 'repo', 'pdf'))
...
def fill_record_electronic(r, entry):
    ...
    _simple_fill(r, entry, ('title', 'howpublished', 'month', 'year', 'note', 'key', 'slides', 'video', 'repo', 'pdf'))
...
def fill_record_incollection(r, entry):
    ...
    _simple_fill(r, entry, ('title', 'year', 'booktitle', 'note', 'key', 'volume', 'number', 'series', 'chapter',
                 'pages', 'address', 'edition', 'month', 'slides', 'video', 'repo', 'pdf'))
...
def fill_record_manual(r, entry):
    ...
    _simple_fill(r, entry, ('title', 'address', 'organization', 'edition', 'month', 'year', 'note', 'key', 'slides', 'video', 'repo', 'pdf'))
...
def fill_record_periodical(r, entry):
    ...
    _simple_fill(r, entry, ('title', 'year', 'number', 'organization', 'note', 'key', 'slides', 'video', 'repo', 'pdf'))
...
def fill_record_phdthesis(r, entry):
    ...
    _simple_fill(r, entry, ('title', 'school', 'year', 'address', 'month', 'note', 'key', 'slides', 'video', 'repo', 'pdf'))
...
def fill_record_proceedings(r, entry):
    ...
    _simple_fill(r, entry, ('title', 'year', 'volume', 'number', 'series', 'address', 'month', 'organization',
                 'note', 'key', 'slides', 'video', 'repo', 'pdf'))
...
def fill_record_techreport(r, entry):
    ...
    _simple_fill(r, entry, ('title', 'institution', 'year', 'number', 'address', 'month', 'note', 'key', 'slides', 'video', 'repo', 'pdf'))
...
def fill_record_unpublished(r, entry):
    ...
    _simple_fill(r, entry, ('title', 'note' 'month', 'year', 'key', 'slides', 'video', 'repo', 'pdf'))
